    ...
    <View style={{ width: "100%" }}>
      <View style={styles.formLayout}>
        ...
        <View style={styles.formInputArea}>
          ...
          <View style={styles.formTextCountContainer}>
            <Text style={[styles.formTextCount, { color: "#FFFFFF" }]}>{form.title.length}</Text>
      ...
      <View style={styles.formLayout}>
        ...
        <View style={styles.formInputArea}>
          ...
          />
          <View style={styles.formTextCountContainer}>
            <Text style={[styles.formTextCount, { color: "#FFFFFF" }]}>{form.description.length}</Text>
      ...
      <View style={[styles.formLayout, { paddingTop: 16, paddingBottom: 16 }]}>
        ...
        <View style={[styles.formInputArea, { flexDirection: "row" }]}>
          <CustomIcon name="iconSearch" color={"#FFFFFF"} size={24} style={{ marginRight: 8 }} />
          <TextInput
